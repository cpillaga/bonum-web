            ...
            >
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 500 }} size="medium">
                        ...
                        <TableBody>
                            {pagosData.map((row, index) => (
                                <TableRow key={row.idPago} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                    <TableCell
                                        align='center'
                                        size='small'
                                        sx={{
                                    ...
                                    >
                                        <div
                                            style={{
                                                ...
                                                backgroundColor: row.estado ? '#00AB55' : '#E58B03',
                                                color: 'white',
                                                justifyContent: 'center',
                                                alignContent: 'center',
                                                borderRadius: 4,
                                        ...
                                        >
                                            {row.estado ? 'Confirmado' : 'Pendiente'}
                                        </div>
                                    </TableCell>
                                    ...
                                    >
                                        <button
                                            ...
                                            onClick={() => console.log(`View: ${row.idPago}`)}
                                        >
                                            {row.estado ?
                                                <div>
                                                    <NavLink
                ...
                >
                    ...
                    >
                        ...
                        >
                            Mostrando {pagosData!.length} de {initialRecords!.length} registros
                        </Typography>
                    </div>
